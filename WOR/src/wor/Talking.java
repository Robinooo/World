...
public class Talking extends Character {
     ...
     * talking character is represented by its name and its two speaches.
     *
     ...
     *
     * @return the first speach of the character, when the player's persuasion
     * rate is low
     */
     ...
     *
     * @return the second speach of the character, when the player's persuasion
     * rate is high
     */
     ...
     *
     * @param persuasion, the speaches depend on the persuasion rate of the
     * player
     * @return getspeach1() if the player's persuasion rate is low or
     * getspeach2() if the player's persuasion rate is high
     */
