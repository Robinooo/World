...
public class Talking extends Character
{
    ...
    /**
     * Constructor for objects of class Talking
     * Create a person talking
     * 
     * @param s1 The first speach of the talking when his rate of persuasion is down
     * @param s2 The second speach of the talking when his rate of persuasion is up
