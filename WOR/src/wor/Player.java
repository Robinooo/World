                ...
                if (testRoom.getDoor().isOpenable() == true) { //if isOpenable -> true if is openable
                    ...
                    if (testRoom.getDoor().getHaveCodeLock()) { //if it's a code lock
                        ...
                        for (int i = 0; i < inv.ItemsList.size(); i++) {
                            if (testRoom.getDoor().openDoorPass(inv.ItemsList.get(i).getName())) { // Try each object from the inventory -> return true if the door is unlock
                        ...
                        for (int i = 0; i < inv.ItemsList.size(); i++) {
                            ...
                            if (testRoom.getDoor().openDoorKey(inv.ItemsList.get(i).getName())) { // Try each object from the inventory -> return true if the door is unlock
