...
public class Lock {
     ...
     *
     * @param b A boolean to modify the lock boolean. A lock is unloked when the
     * boolean is false
     */
     ...
     *
     * @return The boolean of lock state is return. True when the lock is
     * locked. False when the lock is unlocked.
     */
