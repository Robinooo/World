 ...
 * @author Group 2 -  DEGUISE Martin FRICOT Robin DOUMENGE Diane LIEVRE Clémence DUBUISSON Guillaume ROUJOU Lucas
 * @version 20/11/2017
 * 
 */
...
public class Inventory
{
     ...
     * @return : boolean false is the list of items is empty, true if the item is in the list
     */
