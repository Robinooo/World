...
public class World
{
 ...
 fountain.setExit("down",corridor1);
    ...
    // Add the character into rooms
        ...
        keyLivingRoom = new Item ("Keyliving","You found the key of the living room. This is the right occasion to interrogate new suspects. ");
        keyLivingRoom.setHidden(true);
        keyDiningRoom = new Item ("Keydining","You found the dining room’s key. Stroke of luck, the dining room and the living room are communicating rooms !");
